...
<section class="content_page__jumpmenu">
  ...
  <li><a href="#section_about_bob" class="about">About Bob Rosen</a></li>
	</ul>
...
<section id="the_blog" class="content_page__boxes">
	<div class="container">
	<h2 class="box-header blog_header"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 26">
...
<section id="the_book" class="content_page__image-left">
	<div class="container">
		<div class="img">
			<img src="<?php the_field('book_image')['url'] ?>">
		</div>
		<div class="copy">
			<h2><i class="el el-book"></i><?php the_field('book_title'); ?></h2>
			<h3><?php the_field('book_subtitle'); ?></h3>
...
<section class="content_page__seperator">
	...
	<div class="sep-content">
		...
		<?php echo do_shortcode( '[contact-form-7 id="295" title="Book Signup"]') ?>
		</span>
...
<section id="the_podcast" class="content_page__boxes pc_temp">
	<div class="container">
	<!-- <h2 class="box-header"><i class="el el-mic"></i>The Podcast</h2> -->

	<div class="pc_col"><img src="<?= get_template_directory_uri() ?>/assets/images/podcast.png"></div>
	<div class="pc_col">
		<h2 class="box-header"><i class="el el-mic"></i>The Podcast</h2>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam sit amet nibh dignissim, mollis ligula nec, posuere turpis. Etiam ornare mattis purus. Nullam non iaculis velit, vitae mollis felis.</p>

<p>Aliquam non sem in ex hendrerit maximus. Vivamus quis magna ac lacus euismod dignissim. Sed nec venenatis diam. Aliquam lacinia placerat cursus. Aliquam scelerisque rutrum nulla, commodo interdum justo faucibus congue. Phasellus elementum dapibus eleifend. Curabitur aliquam nunc est, quis viverra enim facilisis sit amet. Ut at urna cursus, feugiat nibh eget, ultricies neque.</p>

<p>Add your email below to be on our notification list.</p>
	</div>
...
<section class="content_page__seperator">
	...
	<div class="sep-content">
		<span class="section_form">
		<?php echo do_shortcode( '[contact-form-7 id="297" title="Book Signup_copy"]') ?>
		</span>
	</div>
	</div>
</section>

<section id="section_about_bob" class="content_page__boxes pc_temp">
	<div class="container">
	<!-- <h2 class="box-header"><i class="el el-mic"></i>The Podcast</h2> -->

	<div class="pc_col"><img src="<?= get_template_directory_uri() ?>/assets/images/bob_rosen.png"></div>
	<div class="pc_col">
		<h2 class="box-header">About Bob Rosen</h2>

<p>Bob Rosen is the former owner of six graphic arts companies whose career began on Wall Street, where he was an investment banker.</p>
<p>Educated at Harvard College and NYU Graduate School of Business Administration, he acquired, operated and sold his companies over a period of ten years.</p>
<p>Bob tried retirement and hated it, so he formed Rosen Associates to offer consulting services on CEO-level issues. Over thirty years, the firm has provided advisory services to the CEOs of more than 600 graphic arts companies.</p>
<p>Bob is the author of the groundbreaking book for industry CEOs – The New Graphic Arts CEO. His articles have appeared in virtually every industry publication, and he is a frequent speaker on printing management topics throughout the English-speaking world.</p>
<p>For the past four years, Bob has presented The CEO Roundtable – helping printing company CEOs to be the CEO their companies need. He also developed the industry’s CEO Course and Financial Management Course – both presented at Northwestern University. He is currently developing The Graphic Arts Institute – which will be presented in May, 2018.</p>
<p>Bob served as President of New Jersey’s Association for the Graphic Arts, as a member of PIA’s National Manufacturing Management Committee, and as an advisor to PIA’s Financial Executives Group.</p>
