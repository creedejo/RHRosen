...
<section class="content_page__jumpmenu">
	<div class="container">
	<ul class="jumpmenu">
		<li><a href="#section_the_blog" class="blog"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="30" viewBox="0 0 24 26">
  ...
  <li><a href="#case_studies">Case Studies</a></li>
		<li><a href="#section_the_book" class="book">The Book</a></li>
  <li><a href="#section_the_podcast" class="podcast">The Podcast</a></li>
...
<section id="section_the_blog" class="content_page__boxes">
	<div class="container">
...
<section class="content_page__seperator">
	...
	<div class="bg-bar"></div>
	<div class="sep-content">
		<a href="<?= get_site_url() ?>/case-studies" class="read_more">View All Case Studies</a>
	</div>
...
<section id="section_the_book" class="content_page__image-left">
	<div class="container">
		<div class="img">
...
<section id="section_the_podcast" class="content_page__boxes pc_temp">
	<div class="container">
	<!-- <h2 class="box-header"><i class="el el-mic"></i>The Podcast</h2> -->

	<div class="pc_col"><img src="<?php the_field('pc_image')['url'] ?>"></div>
	<div class="pc_col">
		<h2 class="box-header"><i class="el el-mic"></i><?php the_field('pc_title'); ?></h2>


		<?php the_field('pc_content'); ?>
...
<section id="section_about_bob" class="content_page__boxes pc_temp">
	...
	<div class="pc_col"><img src="<?php the_field('about_bob_image')['url'] ?>"></div>
	<div class="pc_col">
		<h2 class="box-header"><?php the_field('about_bob_title'); ?></h2>

<?php the_field('about_bob_content'); ?>
