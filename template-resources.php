...
<section id="the_podcast" class="content_page__boxes">
	...
	<h2 class="box-header"><i class="el el-mic"></i>The Podcast</h2>
		...
		?>
		<a href="<?php the_field('podcast_url'); ?>" target="_blank" class="content_page__boxes__box">
			<div class="img" style="background-image: url('<?= get_the_post_thumbnail_url( get_the_ID(), 'medium' ) ?>');"></div>
			<h3><?php the_title(); ?></h3>
			<?php the_content(); ?>
			<div class="cta">
...
<section class="content_page__seperator">
	...
	<div class="bg-bar"></div>
	<div class="sep-content">
		<a href="<?= get_field('book_url','option') ?>" target="_blank" class="read_more">View Podcast Page</a>
	</div>
	</div>
</section>
